...
import at.spengergasse.fivepanels.model.medicalcase.Answer;
import at.spengergasse.fivepanels.model.medicalcase.MedicalcaseException;
import at.spengergasse.fivepanels.model.messenger.MessengerException;
...
//    }
    ...
    public Chat addChatMember(Chat chat, Doctor doctorToAdd) {
        return chat.addMember(this, doctorToAdd);
    }
     ...
     *
     * @param doctor the user to whom the friend request is to be sent
     */
    public void addFriend(Doctor doctor) {
        this.socials.addFriend(this, doctor);
    }
     ...
     *
     * @param doctor the user whose friend request is to be accepted
     */
    public void acceptFriendRequest(Doctor doctor) {
        this.socials.acceptFriendRequest(this, doctor);
    }
     ...
     *
     * @param doctor the user whose friend request is to be denied
     */
    public void denyFriendRequest(Doctor doctor) {
        this.socials.denyFriendRequest(this, doctor);
    }
     ...
     *
     * @param doctor the user to be removed from the friend list
     */
    public void removeFriend(Doctor doctor) {
